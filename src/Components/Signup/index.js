...
import { newUser } from '../../Api/userApi.js'
import { useDispatch, useSelector } from 'react-redux'
import { signup } from '../../Reducers/userReducer.js'
    ...
    return (
        <div>
            <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
                ...
                <form onSubmit={handleSignUp} action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
